...
In this dataframe you can create from profvis by saving it and indexing into the first element. You can see all the different labels and calls, times and depth
...
This could be connected and might lead me to choosing profvis for writting and organizing data
